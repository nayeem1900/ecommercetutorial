                    ...
                    <ul class="nav">
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse" id="sidebar_layouts">
                                <ul class="nav flex-column sub-menu">
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{route('admin.categories')}}l"> Manage Category</a>
                                    </li>
                                    <li class="nav-item">
                        ...
                        <!--sample pages start-->
                        <li class="nav-item nav-category">
                            <span class="nav-link">Brand Manage</span>
                        </li>
                        <li class="nav-item">
                            ...
                            <form action="{{route('admin.division.store')}}" method="post" enctype="multipart/form-data">
                               @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="priority" id="exampleInputEmail1" placeholder="Enter Title" >
                                </div>
